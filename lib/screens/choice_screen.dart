    ...
    return MaterialApp(
          home: Scaffold(
            body: Center(child: Column(
              ...
              children: [
                GestureDetector(onTap: (){ checkIfLocationPermissionGiven();}, child: Text("Refresh", style: TextStyle(fontSize: 30),),),
                SizedBox(height: 40,),
                GestureDetector(onTap: ()async{ await LocationPermissions().openAppSettings();}, child: Text("Open Settings", style: TextStyle(fontSize: 30),),),
              ],
            ),),
          ),
        );
...
class _ChoiceScreenState extends State<ChoiceScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    if(permission1 == PermissionStatus.denied || permission1 == PermissionStatus.restricted){ return LocationDisabledScreen();}
    return MaterialApp(
                            ...
                            children: [
                              ...
                              FlatButton(
                                ...
                                onPressed: () async {
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> ShipperLoginScreen(userPosition: userPosition,)));
                                },
                                child: Text(
                                  'Register',
                            ...
                            children: [
                              ...
                              FlatButton(
                                ...
                                onPressed: () async {
                                  WidgetsFlutterBinding.ensureInitialized();
                                  await Firebase.initializeApp();
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=> TransporterLoginScreen(userPosition: userPosition,)));
                                },
                                child: Text(
                                  'Register',
                                  style: TextStyle(fontSize: 25),
